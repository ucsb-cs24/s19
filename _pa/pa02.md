...
(2) How does **the number of nodes visited (proportional to the primitive operations) when inserting a new key in the BST** vary with the number of nodes in the bast? 
